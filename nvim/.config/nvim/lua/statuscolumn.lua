-- Based on config by wookayin: https://github.com/wookayin/dotfiles/blob/9f402a54d37a1f98afa3f47057ff0abb790aa4dd/nvim/lua/config/statuscolumn.lua
-- which itself is based on LazyVim: https://github.com/LazyVim/LazyVim/blob/main/lua/lazyvim/util/ui.lua
